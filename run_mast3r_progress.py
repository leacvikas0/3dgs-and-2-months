#!/usr/bin/env python3
"""
MASt3R SfM Pipeline with Full Progress Display
Uses normal MASt3R's sparse_global_alignment which handles:
- Pair-by-pair inference with progress
- Correspondence matching
- Global optimization with loss display
"""
import sys
import os
import glob
...
CONF_THRESHOLD = 1.0
NITER1 = 500  # Global alignment iterations stage 1
NITER2 = 200  # Global alignment iterations stage 2
# ========================================
...
def main():
    print("=" * 60)
    print("MAST3R SFM PIPELINE (Full Progress)")
    print("=" * 60)
    ...
    print(f"  Expected pairs for {len(image_paths)} images: {len(image_paths) * (len(image_paths) - 1)}")
    
    # 4. Run Global Alignment (this shows all the progress!)
